   ...
   <div id="primary">
    ...
    <div id="post-<?php echo $post->id; ?>" class="<?php echo $post->statusname; ?>">
     ...
     <div class="entry-head">
      <h3 class="entry-title">Product: <a href="<?php echo $post->permalink; ?>" title="<?php echo $post->title; ?>"><?php echo $post->title_out; ?></a></h3>
...
<?php if ( $loggedin ) { ?>
       <span class="entry-edit"><a href="<?php echo $post->editlink; ?>" title="<?php _e('Edit product'); ?>"><?php _e('Edit'); ?></a></span>
<?php } ?>
<?php if ( is_array( $post->tags ) ) { ?>
       <span class="entry-tags"><?php echo $post->tags_out; ?></span>
<?php } ?>
      <p>This product will be held at: <span class='address'><?php echo $post->info->address ?></span></p>
