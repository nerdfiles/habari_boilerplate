...
/**
 * Pennebaker is a custom Theme class for the pennebaker theme.
 *
 * @package Habari
 */
...
/**
 * A custom theme for Pennebaker output
 */
class Pennebaker extends Theme
{
	...
	public function action_init_theme()
	{
		...
		Format::apply( 'format_date', 'post_pubdate_out','<div class="calyear">{Y}</div><div class="calday">{j}</div><div class="calmonth">{F}</div>' );
	}
